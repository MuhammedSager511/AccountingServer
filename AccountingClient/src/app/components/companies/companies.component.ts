...
export class CompaniesComponent {
  ...
  deleteById(model: CompanyModel){
    this.swal.callSwal("Delete Company?",`Do you want to delete the company ${model.name}?`,()=> {
  ...
  migrateAll(){
    this.swal.callSwal("Update Databases?","You are about to update databases for all companies. Continue?", ()=> {
  ...
  seedData(){
    this.swal.callSwal("Create Seed Data?","You are about to create fake data for this company. Continue?", ()=> {
